...
studentsNodes.forEach((node) => {
    let student = new Object();
    const studentFirstName = node.querySelector("first");
    const studentSecondName = node.querySelector("second");
    const studentAge = node.querySelector("age");
    const studentProf = node.querySelector("prof");
